...
(function() {
  ...
  // window.jsonfx;
  var Regex = typeof require === 'function' ? require('./Regex.js') : window.Regex;
  var Executor = typeof require === 'function' ? require('./Executor.js') : window.Executor;
  var math = typeof require === 'function' ? require('./math.js') : window.math;
  var ObjectPositionSystem = typeof require === 'function' ? require('./ObjectPositionSystem.js') : window.ObjectPositionSystem;
  var $ = typeof require === 'function' ? require('jquery') : window.$;
